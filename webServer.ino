      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>Space & IoT Bootcamp </h1>");
            ...
            if (output0State=="off") {
              ...
              client.println("<p><a href=\"/0/off\">OFF</button></a></p>");
            }
            ...
            if (output3State=="off") {
              ...
              client.println("<p><a href=\"/3/off\"><iframe src=\"https://giphy.com/embed/foEsr3OgH5fC8\" width=\"48\" height=\"36\" frameBorder=\"0\" class=\"giphy-embed\" allowFullScreen></iframe>OFF</button></a></p>");
            }     
